...
if ($TERM =~ '256' || &t_Co >= 256) || has("gui_running")
    ...
    hi Cursor ctermbg=NONE ctermfg=254 cterm=NONE guibg=#999999 guifg=#000000 gui=NONE
    hi NonText ctermbg=232 ctermfg=239 cterm=NONE guibg=#080808 guifg=#4e4e4e gui=NONE
    ...
    hi Number ctermbg=NONE ctermfg=254 cterm=NONE guibg=NONE guifg=#99ddff gui=NONE
    ...
    hi String ctermbg=NONE ctermfg=254 cterm=NONE guibg=NONE guifg=#EBDED4 gui=NONE
    ...
    hi texCmd ctermbg=NONE ctermfg=32 cterm=NONE guibg=NONE guifg=#8092b0 gui=NONE
...
elseif &t_Co == 8 || $TERM !~# '^linux' || &t_Co == 16
    ...
    hi NonText ctermbg=darkgray ctermfg=gray cterm=NONE
